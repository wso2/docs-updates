...
![Generate token page](../assets/img/updates/registry-token-genarate-token-1.png)
Upon successful generation, the system will display the **Token Name** and the **Token Secret**. This token is required to pull WSO2 product images from the 

[WSO2 registry](http://registry.wso2.com).  
![Generate token dialog 2](../assets/img/updates/registry-token-genarate-token-2.png)
