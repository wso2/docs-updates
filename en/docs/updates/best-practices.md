...
Here are the guidelines and recommendations to receive the best update experience with WSO2 Updates 2.0.

1. Update frequently

    Frequent updates ensure that the product is bug-free and always up to date with new features, 
    security enhancements, and improvements. WSO2 recommends updating systems weekly or bi-weekly. Before 
    directly applying any updates to your production system, WSO2 always recommends applying any update to lower 
    environments, such as testing, development, or staging environments, which have a similar product distribution as in the 
...
!!! Note  
    Whenever you apply an update, WSO2 recommends that you apply the updates to lower environments, run tests, and update the 
    production environment.
<br>
4.  Getting Updates to a lockdown Environment <br>
    The best practices disseminating updates to production environment with no internet connection are as follows:<br>
    ...
     3. Perform security checks mandated by your organization and verify the updated pack.<br>
     4. Last move the verified pack to the lockdown environment securely.
    
<br> 
5.  Use a Configuration Management tool. <br>
    There are a myriad of benefits of using a Configuration Management Tool. WSO2 advises the use of a Configuration Management Tool, such as [Puppet and Ansible](../faq/#what-are-the-recommended-configuration-management-tools-to-deploy-configurations-to-client-nodes) 
...
<br>
7. WSO2 advises you to keep a copy of your most reliable Docker image in your own private Docker registry for future usage. Further, you can
